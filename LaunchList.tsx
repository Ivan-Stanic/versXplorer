                ...
                (<SafeAreaConsumer>{insets => 
                    <FlatList style={[
                        ...
                        onScroll={event => {
                            ...
                            if (event.nativeEvent.contentOffset.y < this.state.scrollPosition - scrollSensingStep) {
                                // User scrolls up: 

                                if (!(this.state.noMargin)) {
                            ...
                            } else if (event.nativeEvent.contentOffset.y > this.state.scrollPosition + scrollSensingStep) {
                              // User scrolls down: 
